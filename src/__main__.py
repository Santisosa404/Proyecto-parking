...
datos = input('¿Desea cargar el programa con Datos de ejemplos? (S/n)\n')

if datos.lower() == 'S'.lower() or datos.lower() == '':
    # Vehiculos
    ...
    mR2 = MovRed('7899-XDA', datetime(2020, 12, 13))
    mR3 = MovRed('9898-XDB', datetime(2020, 12, 14), datetime.now())
    mR4 = MovRed('9898-XDC', datetime(2020, 12, 15), datetime.now())
    ...
    dicVehiculos = {v1.matricula: v1, v2.matricula: v2, m1.matricula: m1, m2.matricula: m2, mR1.matricula: mR1,
                    mR2.matricula: mR2}
    ...
    dicTicket = {t1.Vehiculo.matricula: t1, t2.Vehiculo.matricula: t2, t3.Vehiculo.matricula: t3,
                 t4.Vehiculo.matricula: t4,
        ...
        if abonadoServicio.comprobarAbonado(dni, matricula):
            ...
            while op2 != '0':
                op2 = input("Pulse 1 para depositar su vehiculo\n"
                            ...
                            "Pulse 0 para salir\n")
                if op2 == '1':
                    pin = input('Para depositar el vehiculo será requerido el pin\n'
                                'Pin: ')
